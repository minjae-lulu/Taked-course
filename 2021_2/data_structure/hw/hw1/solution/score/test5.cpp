...
// This program checks a sequence of operations 
// recorded in an input file

int main(int argc, char *argv[]){
  // checks with a circular list of 4 integers
  ofstream out("log5.txt", std::ios_base::app);
  ...
  out << "your output: " << endl << str << endl;
  out << "desired output: " << endl << line << endl;
  if (line==str)
    out << "SUCCESS\n";
  else
    out << "ERROR\n";
